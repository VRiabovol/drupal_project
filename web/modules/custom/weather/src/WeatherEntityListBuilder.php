...
/**
 * Provides a list controller for the weather entity type.
 */
class WeatherEntityListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new WeatherEntityListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total weather entity: @total', ['@total' => $total]);
    return $build;
  }
