...
class ImageAndTextBehavior extends ParagraphsBehaviorBase {
  ...
  public function view(array &$build, Paragraph $paragraph, EntityViewDisplayInterface $display, $view_mode) {
    ...
    if ($build['field_picture']['#formatter'] == 'image') {
      switch ($image_size) {
        case '6_12':
          $build['field_picture'][0]['#image_style'] = 'image_and_text_6_of_12';
          break;

        case '8_12':
          $build['field_picture'][0]['#image_style'] = 'image_and_text_8_of_12';
          break;
      }
    }
  }
